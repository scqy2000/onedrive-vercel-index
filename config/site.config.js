...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'scqy@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/scqy2000/onedrive-vercel-index',
    },
  ],
